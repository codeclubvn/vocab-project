        ...
        <Theme >
            <section className="flex h-screen w-full overflow-hidden">
                <div className='hidden lg:block lg:w-1/2 relative top-0 bottom-0'>
                    <h1 className='absolute w-2/3 text-[2.6em] max-w-[300px] mt-10 ml-10 font-bold z-10'>Smash sets in your sweats.</h1>
                    <img
                ...
                <div className='w-full lg:w-1/2  my-10 flex-1/2 overflow-scroll h-screen'>
                    <div className="px-[3.4rem] pb-[3rem]">
                        <div className='flex mb-8 text-2xl font-bold'>
                            <Link href='/signup' className='mr-10 hover:border-b-0 '>
                                Đăng kí
                            </Link>
                        ...
                        <div className='flex flex-col w-full mb-8'>
                            <ButtonSocialAuthen description="Đăng nhập với Google" onClick={() => Authentication.signGoogle(dataRespone)} icon={<GoogleIcon className='inline-block w-6 h-6 mr-2 mb-1' />} />
                            <ButtonSocialAuthen description="Đăng nhập với Facebook" onClick={() => Authentication.signFacebook(dataRespone)} icon={<FacebookIcon className='inline-block w-6 h-6 mr-2 mb-1' />} />
                            <ButtonSocialAuthen description="Đăng nhập với Notion" onClick={() => Authentication.signGithub(dataRespone)} icon={<NotionIcon className='inline-block w-6 h-6 mr-2 mb-1' />} />
                        </div>
                        <div className='relative inline-flex items-center justify-center w-full'>
                            <hr className='w-full h-px  bg-gray-200 border-0 dark:bg-gray-700' />
                            <span className='absolute px-3 font-medium text-gray-700 -translate-x-1/5 bg-white dark:text-white dark:bg-gray-900'>hoặc với Email</span>
                        </div>
                        <div className="py-10">
                            <FormSignIn />
                        </div>
