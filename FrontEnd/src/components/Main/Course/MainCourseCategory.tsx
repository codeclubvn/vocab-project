...
export default function MainCourseCategory(props: Props) {
  const Catalogues = [
    'TA Đi làm',
    'TA Giao tiếp',
  ...
  const MainCourseCategory = Catalogues.map((name, idx) => {
    return (
      <div
  ...
  return (
    <div className={`${props.className}`}>
      <h2 className='h-min text-2xl'>MainCourseCategory</h2>
