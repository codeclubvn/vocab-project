...
const MainLessonDetailFlipCard = (props: Props) => {
  ...
  return (
    ...
    >
      <div
        className='flex flex-col w-[814px] h-[428px]  rounded-lg shadow-xl py-6 px-8 bg-[#f1ebeb] overflow-y-auto'
      ...
      <div
        className={`flex flex-col min-h-full w-[814px] h-[428px]  rounded-lg shadow-xl py-6 px-8 bg-[#ffffff] `}
        onClick={handleOnClick}
        role='button'
        tabIndex={0}
      >
...
export default MainLessonDetailFlipCard
